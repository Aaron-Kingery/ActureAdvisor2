                ...
                <div className="space-y-4">
                    {feedback.map(item => (
                        <div
                            ...
                            className={`p-4 bg-white rounded-lg shadow-sm cursor-pointer border hover:border-acture-primary transition ${selectedItem?.id === item.id ? 'border-acture-primary ring-1 ring-acture-primary' : 'border-gray-200'}`}
                        >
                    ...
                    <div>
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                className="bg-acture-primary text-white px-4 py-2 rounded hover:opacity-90"
                            >
                                Mark Resolved
                            </button>
                            <button
